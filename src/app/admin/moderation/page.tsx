...
export const metadata: Metadata = generateMetadata(
  "Moderasyon",
  "THY Forum moderasyon işlemleri ve içerik yönetimi"
);
...
const moderationQueue = [
  ...
  },
  {
    id: "4",
    type: "Yorum",
    content: "Bagaj problemi çözümü yorumu",
    author: "can_ozturk",
...
const contentTypes = ["Tümü", "Konu", "Yorum"];
const moderationStatuses = ["Tümü", "Beklemede", "İnceleniyor", "Onaylandı", "Reddedildi"];
        ...
        <CardHeader>
          <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
            <div>
              ...
              <CardDescription>
                İnceleme bekleyen içerikleri yönetin
              </CardDescription>
            </div>
          </div>
        </CardHeader>
        <CardContent>
          <div className="flex flex-col gap-4 sm:flex-row sm:items-center py-4">
            <div className="relative flex-1">
              ...
              <Input placeholder="İçerik ara..." className="pl-8" />
            </div>
